...
public class ShrinesSettingsConfig {
    ...
    public final ForgeConfigSpec.BooleanValue ENABLE_RANDOM_VARIATION;
    ...
    public ShrinesSettingsConfig(final ForgeConfigSpec.Builder SERVER_BUILDER) {
        ...
        ENABLE_RANDOM_VARIATION = SERVER_BUILDER.comment(
                        "Enable random variation. Set to false to disable for all structures. This overrides every other config")
                .translation("config.shrines.activate_random_variation").define("structures.activate_random_variation", true);
    }
