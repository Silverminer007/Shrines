...
public class StructureConfig {
	...
	public final StructureGenConfig ORIENTAL_SANCTUARY;
	...
	public StructureConfig(final ForgeConfigSpec.Builder SERVER_BUILDER) {
		...
		NETHER_PYRAMID = new LootableStructureGenConfig.LootableConfigBuilder("Nether Pyramid", "nether_pyramid",
				7428394).setDistance(150).setSeparation(50).addDimension("nether").addBiome(Category.NETHER)
						.build(SERVER_BUILDER);
		...
		FLOODED_TEMPLE = new LootableStructureGenConfig.LootableConfigBuilder("Flooded Temple", "flooded_temple",
				54315143).setDistance(50).setSeparation(10).setUseRandomVarianting(false).removeBiome(Category.DESERT)
						.removeBiome(Category.MESA).build(SERVER_BUILDER);
		...
		GUARDIAN_MEETING = new LootableStructureGenConfig.LootableConfigBuilder("Guardian Meeting", "guardian_meeting",
				1498473232).setLootChance(1.0D).setDistance(70).setSeparation(17).setUseRandomVarianting(false)
						.build(SERVER_BUILDER);
		ORIENTAL_SANCTUARY = new StructureGenConfig.ConfigBuilder("Oriental Sanctuary", "oriental_sanctuary", 987432987)
				.setDistance(50).setSeparation(14).setUseRandomVarianting(true).build(SERVER_BUILDER);
		BLACKLISTED_BIOMES = SERVER_BUILDER
				.comment("Structure Generation Config", "Take care what you change, this changes may cant be undone",
						"", "Biomes where NO Structure (of this mod) can generate in. Custom structures too")
				.defineList("structures.blacklisted_biomes", Lists.newArrayList(), StructureConfig::validateBiome);
		...
		END_TEMPLE = new LootableStructureGenConfig.LootableConfigBuilder("End Temple", "end_temple", 32 ^ 478392)
				...
				.setDimension(Lists.newArrayList("end")).build(SERVER_BUILDER);
		CUSTOM = null;
	...
	public static class StructureGenConfig {
		...
		public StructureGenConfig(final ForgeConfigSpec.Builder SERVER_BUILDER, String name, String dataName,
				...
				boolean useRandomVarianting, ArrayList<String> blacklist, ArrayList<String> dimensions,
			...
			DIMENSIONS = SERVER_BUILDER.comment("Here's a list of all dimensions where " + name + " can spawn in")
					.defineList("structures." + dataName + ".dimensions", dimensions, o -> o != null);
		...
		public static class ConfigBuilder {
			...
			public StructureGenConfig build(final ForgeConfigSpec.Builder SERVER_BUILDER) {
				return new StructureGenConfig(SERVER_BUILDER, name, dataName, spawnChance, distance, separation, seed,
						needsGround, useRandomVarianting, blacklist, dimensions, biomes.toArray(Category[]::new));
			}
	...
	public static class LootableStructureGenConfig extends StructureGenConfig {
		...
		public LootableStructureGenConfig(Builder SERVER_BUILDER, String name, String dataName, double dSpawnChance,
			...
			super(SERVER_BUILDER, name, dataName, dSpawnChance, dDistance, dSeparation, dSeed, needsGround,
					useRandomVarianting, blacklist, dimensions, biomeCategories);
		...
		public static class LootableConfigBuilder extends ConfigBuilder {
			...
			public LootableStructureGenConfig build(final ForgeConfigSpec.Builder SERVER_BUILDER) {
				return new LootableStructureGenConfig(SERVER_BUILDER, name, dataName, spawnChance, distance, separation,
						seed, lootChance, needsGround, useRandomVarianting, blacklist, dimensions,
						biomes.toArray(Category[]::new));
			}
			...
			public LootableConfigBuilder addDimension(String dimension) {
				this.dimensions.add(dimension);
				return this;
			}

			public LootableConfigBuilder setDimension(ArrayList<String> dimension) {
				this.dimensions = dimension;
				return this;
			}
			...
			public LootableConfigBuilder addBiome(Category biome) {
				this.biomes.add(biome);
				return this;
			}

			public LootableConfigBuilder removeBiome(Category biome) {
				this.biomes.add(biome);
				return this;
			}
	...
	public static class HarbourStructureGenConfig extends LootableStructureGenConfig {
		...
		public HarbourStructureGenConfig(Builder SERVER_BUILDER, String name, String dataName, double dSpawnChance,
				int dDistance, int dSeparation, int dSeed, double dLootChance, boolean needsGround,
				boolean useRandomVarianting, ArrayList<String> blacklist, ArrayList<String> dimensions,
				boolean spawnVillagers, Category... biomeCategories) {
		...
		public static class LootableHarbourConfigBuilder extends LootableConfigBuilder {
			...
			public HarbourStructureGenConfig build(final ForgeConfigSpec.Builder SERVER_BUILDER) {
				return new HarbourStructureGenConfig(SERVER_BUILDER, name, dataName, spawnChance, distance, separation,
						seed, lootChance, needsGround, useRandomVarianting, blacklist, dimensions, spawn_villagers,
						biomes.toArray(Category[]::new));
			}
			...
			public LootableHarbourConfigBuilder addDimension(String dimension) {
				this.dimensions.add(dimension);
				return this;
			}

			public LootableHarbourConfigBuilder setDimension(ArrayList<String> dimension) {
				this.dimensions = dimension;
				return this;
			}
			...
			public LootableHarbourConfigBuilder addBiome(Category biome) {
				this.biomes.add(biome);
				return this;
			}

			public LootableHarbourConfigBuilder removeBiome(Category biome) {
				this.biomes.add(biome);
				return this;
			}
