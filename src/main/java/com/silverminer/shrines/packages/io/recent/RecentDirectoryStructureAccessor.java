...
public class RecentDirectoryStructureAccessor implements DirectoryStructureAccessor {
   ...
   public Path getBasePath() {
      return this.getMinecraftPath().resolve("shrines-data").resolve("3.x.x");
   }
   ...
   public Path getStructuresPath(@NotNull ResourceLocation location, String packageName, boolean extension) {
      return this.getStructuresPath(location, this.getPackagesPath().resolve(packageName), extension);
   }
