...
public class StructureData implements Comparable<StructureData> {
   ...
   public StructureData(CompoundNBT data) {
      ...
      this.heightmapType = Heightmap.Type.CODEC.decode(NBTDynamicOps.INSTANCE, data.getCompound(ConfigOptions.heightmap_type)).get().left().map(Pair::getFirst).orElse(Heightmap.Type.WORLD_SURFACE_WG);
   ...
   public StructureData(DefaultedStructureData data) {
      ...
      this.heightmapType = data.getHeightmapType();
   }
   ...
   public CompoundNBT write(CompoundNBT tag) {
      ...
      tag.put(ConfigOptions.heightmap_type, Heightmap.Type.CODEC.encode(this.getHeightmapType(), NBTDynamicOps.INSTANCE, new CompoundNBT()).get().left().orElse(new CompoundNBT()));
   ...
   public void setHeightmapType(Heightmap.Type heightmapType) {
