...
public class GuardianStructure extends AbstractStructure<NoFeatureConfig> {

	public GuardianStructure(Codec<NoFeatureConfig> codec) {
		super(codec, 3, "dummy");
	}
	...
	public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
		return GuardianStructure.Start::new;
	}
	...
	public static class Start extends AbstractStructureStart<NoFeatureConfig> {
		...
		public void func_230364_a_(DynamicRegistries registries, ChunkGenerator chunkGenerator,
			...
			GuardianPiece.generate(templateManager, blockpos, rotation, this.components, this.rand);
