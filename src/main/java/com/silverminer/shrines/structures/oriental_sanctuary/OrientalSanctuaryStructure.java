...
public class OrientalSanctuaryStructure extends AbstractStructure {
	public static final String NAME = "oriental_sanctuary";
	...
	public OrientalSanctuaryStructure(Codec<VillageConfig> codec) {
		super(codec, NAME, ORIENTALSANCTUARY_CONFIG);
	}
	...
	public JigsawPattern getPools() {
		return StructurePools.ORIENTAL_SANCTUARY;
	}
}