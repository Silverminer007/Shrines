...
public class DummyPiece {
	...
	public static void generate(TemplateManager templateManager, BlockPos pos, Rotation rotation,
		...
		boolean flag = true;
		if (flag)
			pieces.add(new DummyPiece.Piece(templateManager, location.get(random.nextInt(location.size())), pos,
					rotation, 0, random));
		else
			// Test function for single variant
			pieces.add(new DummyPiece.Piece(templateManager, location.get(0), pos, rotation, 0, random));
	}
	...
	public static class Piece extends ColorStructurePiece {
		...
		public Piece(TemplateManager templateManager, ResourceLocation location, BlockPos pos, Rotation rotation,
			...
			super(StructurePieceTypes.DUMMY, templateManager, location, pos, rotation, componentTypeIn, true);
		}

		public Piece(TemplateManager templateManager, CompoundNBT cNBT) {
			super(StructurePieceTypes.DUMMY, templateManager, cNBT);
		}
