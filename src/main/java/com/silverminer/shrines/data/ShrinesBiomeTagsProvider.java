...
public class ShrinesBiomeTagsProvider extends TagsProvider<Biome> {
    ...
    public static final TagKey<Biome> NETHER_PYRAMID = createShrines("nether_pyramid");
    public static final TagKey<Biome> NETHER_SHRINE = createShrines("nether_shrine");
    ...
    protected ShrinesBiomeTagsProvider(DataGenerator dataGenerator, @Nullable ExistingFileHelper existingFileHelper) {
        super(dataGenerator, BuiltinRegistries.BIOME, ShrinesMod.MODID, existingFileHelper, Registry.BIOME_REGISTRY.location().getPath());
    }
    ...
    protected void addTags() {
        ...
        this.tag(MINERAL_TEMPLE).addTag(IS_PLAINS).addTag(BiomeTags.IS_FOREST).addTag(BiomeTags.IS_TAIGA).addTag(IS_SAVANNA).addTag(BiomeTags.IS_JUNGLE)
                .addTag(IS_MESA).addTag(IS_ICY).addTag(IS_DESERT).addTag(IS_SWAMP).addTag(IS_MUSHROOM);
        this.tag(NETHER_PYRAMID).addTag(IS_PLAINS).addTag(BiomeTags.IS_FOREST).addTag(BiomeTags.IS_TAIGA).addTag(IS_SAVANNA).addTag(BiomeTags.IS_JUNGLE)
                .addTag(IS_MESA).addTag(IS_ICY).addTag(IS_DESERT).addTag(IS_SWAMP).addTag(IS_MUSHROOM).addTag(IS_NETHER);
        this.tag(NETHER_SHRINE).addTag(IS_PLAINS).addTag(BiomeTags.IS_FOREST).addTag(BiomeTags.IS_TAIGA).addTag(IS_SAVANNA).addTag(BiomeTags.IS_JUNGLE)
                .addTag(IS_MESA).addTag(IS_ICY).addTag(IS_DESERT).addTag(IS_SWAMP).addTag(IS_MUSHROOM).addTag(IS_NETHER);
