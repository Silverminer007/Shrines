...
public class ShrinesPacketHandler {
    ...
    public static void register() {
        ...
        CHANNEL.registerMessage(id++, STCSyncAvailableMaterialsATypes.class, STCSyncAvailableMaterialsATypes::toBytes, STCSyncAvailableMaterialsATypes::new, STCSyncAvailableMaterialsATypes::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        CHANNEL.registerMessage(id++, CTSSyncAvailableMaterialATypesRequest.class, CTSSyncAvailableMaterialATypesRequest::toBytes, CTSSyncAvailableMaterialATypesRequest::new, CTSSyncAvailableMaterialATypesRequest::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
