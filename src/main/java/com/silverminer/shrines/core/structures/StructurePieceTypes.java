...
import com.silverminer.shrines.core.structures.ballon.BallonPiece;
import com.silverminer.shrines.core.structures.bees.BeesPiece;
import com.silverminer.shrines.core.structures.custom.CustomPiece;
import com.silverminer.shrines.core.structures.end_temple.EndTemplePiece;
import com.silverminer.shrines.core.structures.flooded_temple.FloodedTemplePiece;
import com.silverminer.shrines.core.structures.guardian_meeting.GuardianMeetingPiece;
import com.silverminer.shrines.core.structures.harbour.HarbourPieces;
import com.silverminer.shrines.core.structures.harbour.HarbourPieces.HarbourBuildingPiece;
import com.silverminer.shrines.core.structures.harbour.test.BetterHarbourPieces;
import com.silverminer.shrines.core.structures.high_tempel.HighTempelPiece;
import com.silverminer.shrines.core.structures.jungle_tower.JungleTowerPiece;
import com.silverminer.shrines.core.structures.mineral_temple.MineralTemplePiece;
import com.silverminer.shrines.core.structures.nether_pyramid.NetherPyramidPiece;
import com.silverminer.shrines.core.structures.nether_shrine.NetherShrinePiece;
import com.silverminer.shrines.core.structures.player_house.PlayerhousePiece;
import com.silverminer.shrines.core.structures.prison.InfestedPrisonPiece;
import com.silverminer.shrines.core.structures.small_tempel.SmallTempelPiece;
import com.silverminer.shrines.core.structures.water_shrine.WaterShrinePiece;
import com.silverminer.shrines.core.structures.witch_house.AbandonedWitchHousePiece;
...
public class StructurePieceTypes {
	...
	public static void regsiter() {
		...
		Registry.register(Registry.STRUCTURE_PIECE, new ResourceLocation(ShrinesMod.MODID, "better_harbour"), BETTER_HARBOUR);
