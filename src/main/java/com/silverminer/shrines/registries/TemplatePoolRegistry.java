...
public class TemplatePoolRegistry {
   ...
   public static final RegistryObject<StructureTemplatePool> ABANDONED_VILLA = new PoolBuilder().setDirectory("abandoned_villa").addSingleTemplate(d("abandoned_villa")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> ABANDONED_WITCH_HOUSE = new PoolBuilder().setDirectory("abandoned_witch_house").addSingleTemplate(d("abandoned_witch_house")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> AZALEA_PAVILION = new PoolBuilder().setDirectory("azalea_pavilion").addSingleTemplate(d("azalea_pavilion")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> BALLOON = new PoolBuilder().setDirectory("balloon")
   ...
   public static final RegistryObject<StructureTemplatePool> HARBOUR_BUILDINGS = new PoolBuilder().setDirectory("harbour").setFileName("buildings")
         ...
         .buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> HARBOUR_STREET = new PoolBuilder().setDirectory("harbour").setFileName("street")
         ...
         .buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> HARBOUR_WARE = new PoolBuilder().setDirectory("harbour").setFileName("ware")
   ...
   public static final RegistryObject<StructureTemplatePool> NETHER_SHRINE = new PoolBuilder().setDirectory("nether_shrine")
         ...
         .buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> MODERN_VILLA = new PoolBuilder().setDirectory("modern_villa").addSingleTemplate(d("modern_villa")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> ORIENTAL_HUT = new PoolBuilder().setDirectory("oriental_hut").addSingleTemplate(d("oriental_hut")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> ORIENTAL_SANCTUARY = new PoolBuilder().setDirectory("oriental_sanctuary").addSingleTemplate(d("oriental_sanctuary")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> INFESTED_PRISON = new PoolBuilder().setDirectory("infested_prison").addSingleTemplate(d("infested_prison")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> SHRINE_OF_SAVANNA = new PoolBuilder().setDirectory("shrine_of_savanna").addSingleTemplate(d("shrine_of_savanna")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> SMALL_PLAYER_HOUSE = new PoolBuilder().setDirectory("small_player_house").addLegacyTemplate(d("small_player_house")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> SMALL_TEMPLE = new PoolBuilder().setDirectory("small_temple").addSingleTemplate(d("small_temple")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> TALL_PLAYER_HOUSE = new PoolBuilder().setDirectory("tall_player_house")
         ...
         .buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> TRADER_HOUSE = new PoolBuilder().setDirectory("trader_house").addSingleTemplate(d("trader_house")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> WATCH_TOWER = new PoolBuilder().setDirectory("watch_tower").addSingleTemplate(d("watch_tower")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> WATER_SHRINE = new PoolBuilder().setDirectory("water_shrine").addSingleTemplate(d("water_shrine")).buildAndRegister();
   public static final RegistryObject<StructureTemplatePool> WORLD_TREE_MANOR = new PoolBuilder().setDirectory("world_tree_manor").addSingleTemplate(d("world_tree_manor")).buildAndRegister();
