...
public class DynamicRegistriesRegistry {
    public static final DeferredRegister<StructureNovel> NOVELS = null;
    //RegistryAccessExtension.createRegister(StructureNovel.class, StructureNovel.REGISTRY);
    public static final DeferredRegister<NewVariationConfiguration> VARIATION_CONFIGURATION = null;
    //RegistryAccessExtension.createRegister(NewVariationConfiguration.class, NewVariationConfiguration.REGISTRY);
    public static final DeferredRegister<NewVariationMaterial> VARIATION_MATERIAL = null;
